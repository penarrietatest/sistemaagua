...
<script type="text/javascript">
        $(".btn-view-factura").on("click", function(){
            ...
            html +=             "<address>"
            html +=                 "<strong>CI: " + ipay[11] + "</strong><br>"
            html +=                 "<b>Afiliado:</b> " + ipay[9] + "<br>"
            html +=                 "<b>Direccion:</b> " + ipay[12] + "<br>"
            html +=                 "<b>Manzano:</b> " + ipay[14] +" <b>Lote:</b> " + ipay[15] + "<br>"
            html +=                 "<b>Lectura anterior:</b> " + ipay[5] + " &nbsp;&nbsp; <b>Fecha: </b> " + ipay[7] + "<br>"
            html +=                 "<b>Lectura actual:</b> " + ipay[6] + " &nbsp;&nbsp; <b>Fecha: </b> " + ipay[8] + ""
            html +=             "</address>"
            html +=           "</div>"
            html +=           "<div class='col-sm-6 invoice-col'>"    
            html +=              "<address>"
            html +=                 "<strong>Nro medidor: " + ipay[13] + "</strong><br>"
            ...
            html +=                            "<td>Notificacion</td>"
            html +=                            "<td class='text-right'> " + ipay[10] + " Bs</td>"
            html +=                          "</tr>"   
                                          }
            html +=                      "</tbody>"
            html +=                 "</table>"      
            ...
            html +=                   "<hr>"
            html +=                   "<h4><b>Total :</b> " + ipay[4] + " Bs</h4>" 
            html +=               "</div>"
            html +=           "</div>"
